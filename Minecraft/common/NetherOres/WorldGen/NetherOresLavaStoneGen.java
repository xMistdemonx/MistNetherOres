...
public class NetherOresLavaStoneGen extends WorldGenerator
{
    ...
    public NetherOresLavaStoneGen(int par1, int par2)
    {
        minableBlockId = par1;
        numberOfBlocks = par2;
    }
            ...
            for (int l1 = j; l1 <= i1; l1++)
            {
                ...
                for (int i2 = k; i2 <= j1; i2++)
                {
                    ...
                    for (int j2 = l; j2 <= k1; j2++)
                    {
                        ...
                        if (d12 * d12 + d13 * d13 + d14 * d14 < 1.0D && par1World.getBlockId(l1, i2, j2) == Block.lavaStill.blockID)
                        {
                            par1World.setBlockWithNotify(l1, i2, j2, minableBlockId);
                        }
                    }
                }
            }
